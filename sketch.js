...
function preload() {
  ...
  meatSheet = loadImage("assets/meat.png");
}
...
function setup() {
  ...
  meatSheet.loadPixels();
  let pixels = meatSheet.pixels;
  for (let i=0; i < pixels.length; i += 4) {
    if (pixels[i] === pixels[0] && pixels[i+1] === pixels[1] && pixels[i+2] === pixels[2]) {
      pixels[i+3] = 0;
    } 
  }
  meatSheet.updatePixels();

  walkingAnimation = new WalkingAnimation(spriteSheet,80,80,200,179,9);
  walkingAnimation2 = new WalkingAnimation(spriteSheet,80,80,50,50,9);
  meatAnimation = new WalkingAnimation(meatSheet,80,80,40,350,9);
  meatAnimation2 = new WalkingAnimation(meatSheet,80,80,170,40,9);
  walkingAnimation3 = new WalkingAnimation(spriteSheet,80,80,350,250,9);
}
...
function keyPressed() {
  ...
  meatAnimation.keyPressed(LEFT_ARROW,RIGHT_ARROW);
  meatAnimation2.keyPressed(LEFT_ARROW,RIGHT_ARROW);
...
function keyReleased() {
  ...
  meatAnimation.keyReleased(LEFT_ARROW,RIGHT_ARROW);
  meatAnimation2.keyReleased(LEFT_ARROW,RIGHT_ARROW);
